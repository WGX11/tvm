...
set(USE_CUDNN  OFF)
set(USE_CUTLASS OFF)
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -fprofile-arcs -ftest-coverage" CACHE STRING "C++ flags" FORCE)
set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -fprofile-arcs -ftest-coverage" CACHE STRING "C flags" FORCE)

# 强制覆盖链接器标志
set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -lgcov" CACHE STRING "Executable linker flags" FORCE)